...
- Dart can be extensively  used to create single-page applications .
     ...
     GMail ─ when you click on a message in your inbox, browser stays on the same webpage.
     but JavaScript code hides the inbox and brings the message body on screen.
- Google has released r a special  build of Chromium – the Dart VM.
